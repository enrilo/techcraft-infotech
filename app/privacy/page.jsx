export const metadata = {
  ...
  description:
    "How TechCraft Infotech collects, uses, and protects data through the techcraftinfotech.com website.",
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-24">
      ...
      <p className="text-[1rem] text-ink2">
        ...
        information when you visit this website, techcraftinfotech.com. It also
      ...
      <p className="mt-4 text-[1rem] text-ink2">
        ...
        student, and employee records that customer consultancies manage in
        the product.
      </p>
      ...
      <ul className="list-disc space-y-2 pl-5 text-[1rem] text-ink2">
        <li>
          ...
          a demo, or apply for a role through this website.
        </li>
        <li>
          <strong>Usage and device data.</strong> Collected through Google
          Analytics and our hosting infrastructure — pages visited, referring
          site, approximate location (derived from IP, which is truncated),
          browser and device type, and timestamps.
        </li>
        <li>
          <strong>Cookies and similar technologies.</strong> Small files stored
          on your device. See <em>Cookies and analytics</em> below.
        </li>
      </ul>
      ...
      <ul className="list-disc space-y-2 pl-5 text-[1rem] text-ink2">
        ...
        <li>
          To send service and administrative messages (for example, security
          notices or material changes to our terms)
        </li>
        <li>
      ...
      <p className="text-[1rem] text-ink2">
        ...
        your request (to respond to enquiries); our{" "}
        <strong>legitimate interests</strong> (to secure and improve this
        website, where not overridden by your rights); and{" "}
        <strong>legal obligation</strong> (to meet regulatory and tax
        requirements).
      </p>
      ...
      <p className="text-[1rem] text-ink2">
        ...
        that sets no cookies and does not identify you. If you accept, Google
        Analytics sets cookies and collects usage data; if you decline, it
        stays in the restricted, cookie-free mode. You can change your choice
        any time with the &ldquo;Cookie Preferences&rdquo; link in the footer,
        or opt out using your browser settings or the Google Analytics opt-out
        browser add-on. We do not use advertising or cross-site tracking
        cookies.
      </p>
      ...
      <ul className="mt-3 list-disc space-y-2 pl-5 text-[1rem] text-ink2">
        ...
        <li>
          <strong>Professional advisers</strong> such as auditors and lawyers,
          where necessary
        </li>
        <li>
          <strong>Authorities or acquirers</strong> where required by law, to
          protect our rights, or in connection with a merger, acquisition, or
          sale of assets
        </li>
      </ul>
      ...
      <p className="text-[1rem] text-ink2">
        ...
        period configured in Google Analytics, unless the law requires us to
        keep it longer.
      </p>
      ...
      <p className="text-[1rem] text-ink2">
        ...
        <a
          href="mailto:hello@techcraftinfotech.com"
