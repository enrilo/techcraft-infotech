export const metadata = {
  ...
  description:
    "Terms governing the use of the techcraftinfotech.com website.",
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-24">
      ...
      <p className="text-[1rem] text-ink2">
        ...
        of this website, techcraftinfotech.com, operated by TechCraft Infotech
      ...
      <p className="text-[1rem] text-ink2">
        ...
        belong to TechCraft Infotech or its licensors and are protected by
      ...
      <p className="text-[1rem] text-ink2">
        To the maximum extent permitted by law, TechCraft Infotech will not be
